...
const routeContracts: LinkContract[] = [
  ...
  {
    label: "Campaign recommendation action API",
    href: "/api/v1/provider/campaigns/optimization-recommendations/actions",
    method: "POST",
    owner: "provider"
  },
  ...
  { label: "App device registration API", href: "/api/v1/app/devices", method: "POST", owner: "family" },
  ...
  { label: "Production origin diagnostics API", href: "/api/v1/system/production-origin-diagnostics", method: "GET", owner: "admin" },
  ...
  { label: "Credential smoke evidence API", href: "/api/v1/system/credential-smoke-evidence", method: "GET", owner: "admin" },
  { label: "Credential smoke evidence CSV", href: "/api/v1/system/credential-smoke-evidence?format=csv", method: "GET", owner: "admin" },
  { label: "Credential smoke evidence archive API", href: "/api/v1/system/credential-smoke-evidence", method: "POST", owner: "admin" },
  { label: "Credential evidence retention API", href: "/api/v1/system/credential-evidence-retention", method: "GET", owner: "admin" },
  { label: "Credential evidence retention CSV", href: "/api/v1/system/credential-evidence-retention?format=csv", method: "GET", owner: "admin" },
  { label: "Credential evidence retention review API", href: "/api/v1/system/credential-evidence-retention", method: "POST", owner: "admin" },
  ...
  {
    label: "Provider ad reporting API",
    href: "/api/v1/provider/ads/reporting?providerId=seed-cottages-dayton-place",
    method: "GET",
    owner: "provider"
  },
  ...
  {
    label: "Webhook replay evidence export API",
    href: "/api/v1/admin/webhook-deliveries/replay/export?format=csv&sourceStatus=failed&replayStatus=queued&auditedOnly=true",
    method: "GET",
    owner: "admin"
  },
  ...
  { label: "Partner live smoke readiness API", href: "/api/v1/admin/partner-smoke-suite/live-readiness", method: "GET", owner: "admin" },
  {
    label: "Partner live smoke readiness CSV export",
    href: "/api/v1/admin/partner-smoke-suite/live-readiness?format=csv",
    method: "GET",
    owner: "admin"
  },
  ...
  { label: "Internal notification queue readiness API", href: "/api/v1/admin/internal-notification-queue/readiness", method: "GET", owner: "admin" },
  ...
  {
    label: "External review integrations API",
    href: "/api/v1/provider/external-review-integrations?providerId=seed-cottages-dayton-place",
    method: "GET",
    owner: "provider"
  },
  {
