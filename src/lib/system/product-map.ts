...
const productPillars: ProductPillar[] = [
  {
    ...
    backendRoutes: [
      ...
      "GET /api/v1/admin/provider-claims/{id}/evidence",
  ...
  },
  {
    ...
    backendRoutes: [
      ...
      "POST /api/v1/admin/community/digests/run",
      ...
      "GET /api/v1/community/trust-score",
  ...
  },
  {
    ...
    backendRoutes: [
      ...
      "POST /api/v1/provider/events/{id}/follow-up-composer",
  ...
  },
  {
    ...
    backendRoutes: [
      ...
      "POST /api/v1/provider/campaigns/optimization-recommendations/actions",
    ...
    requiredTables: [
      ...
      "campaign_creatives",
      "campaign_metrics",
      "campaign_recommendation_actions",
      "ai_generations",
      "content_assets",
      "social_posts",
  ...
  },
  {
    ...
    backendRoutes: [
      ...
      "GET /api/v1/provider/ads/reporting",
  ...
  },
  {
    ...
    backendRoutes: [
      ...
      "GET /api/v1/admin/import-batches/{id}/evidence",
      ...
      "GET /api/v1/admin/extracted-entities/duplicate-review",
      "GET /api/v1/admin/extracted-entities/duplicate-review?format=csv",
  ...
  },
  {
    ...
    backendRoutes: [
      ...
      "GET /api/v1/provider/reputation-readiness",
      "GET /api/v1/provider/reputation-trends",
      "POST /api/v1/provider/reputation-trends",
      "GET /api/v1/provider/review-requests",
      "GET /api/v1/admin/reviews/moderation-dashboard",
      "POST /api/v1/provider-portal/reviews/{id}/responses/publish"
    ],
    requiredTables: [
      "reviews",
  ...
  },
  {
    ...
    backendRoutes: [
      ...
      "POST /api/v1/admin/newsroom/newsletters/{id}/audience-export",
  ...
  },
  {
    ...
    backendRoutes: [
      ...
      "GET /api/v1/admin/partner-smoke-suite/live-readiness",
      "GET /api/v1/admin/partner-smoke-suite/live-readiness?format=csv",
      ...
      "GET /api/v1/partner/response-pagination",
      "GET /api/v1/partner/pagination-evaluation",
      "GET /api/v1/partner/pagination-evaluation?format=csv",
      "GET /api/v1/partner/pagination-volume-evidence",
      "GET /api/v1/partner/pagination-volume-evidence?format=csv",
    ...
    nextBackendWork: ["Owner-approved SDK registry publishing", "Owner-approved live partner smoke key custody and archive evidence", "Owner-approved cursor pagination production volume evidence"]
  },
  {
    ...
    backendRoutes: [
      ...
      "GET /api/v1/system/dns-cutover-smoke-checklist",
      "POST /api/v1/system/dns-cutover-smoke-checklist",
      "GET /api/v1/system/public-domain-smoke",
      "POST /api/v1/system/public-domain-smoke",
      "GET /api/v1/system/production-origin-diagnostics",
