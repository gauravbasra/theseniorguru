...
const productPillars: ProductPillar[] = [
  {
    ...
    nextBackendWork: ["Provider-facing edit approval status UI", "Messaging provider adapter for verification delivery", "Provider claim SLA alert live queue adapter"]
  },
  {
    key: "mobile",
  ...
  },
  {
    ...
    nextBackendWork: ["CMS/state import adapters", "Provider website extraction parser", "Import escalation provider integration"]
  },
  {
    key: "reviews",
