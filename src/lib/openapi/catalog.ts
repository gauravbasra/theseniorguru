  ...
  return {
    ...
    paths: {
      ...
      "/api/v1/partner/providers/{id}/visibility": {
        get: { tags: ["Providers"], summary: "Partner provider visibility readiness API requiring providers:read scope with aggregate scores" }
      },
      "/api/v1/partner/providers/{id}/reputation-readiness": {
        get: { tags: ["Reviews"], summary: "Partner provider reputation readiness API requiring reviews:read scope with aggregate review, campaign, and sentiment health" }
      },
      "/api/v1/partner/providers/{id}/review-summary": {
        get: { tags: ["Reviews"], summary: "Partner provider review summary API requiring reviews:read scope with aggregate rating, source, and sentiment metrics" }
      },
      "/api/v1/partner/providers/{id}/event-summary": {
        get: { tags: ["Events"], summary: "Partner provider event summary API requiring events:read scope with aggregate RSVP, promotion, and ad metrics" }
      },
      ...
      "/api/v1/partner/events/{id}/analytics": {
        get: { tags: ["Events"], summary: "Partner event analytics API requiring events:read scope with aggregate RSVP and promotion metrics" }
      },
      ...
      "/api/v1/partner/newsroom/sources": {
        get: { tags: ["Newsroom"], summary: "Partner approved newsroom source registry API requiring newsroom:read scope with attribution metadata" }
      },
      ...
      "/api/v1/partner/claims/{id}/verification-evidence": {
        post: { tags: ["Claims"], summary: "Partner provider claim evidence submission API requiring claims:write scope, claimant email match, and attestation" }
      },
      ...
      "/api/v1/partner/sdk-publish-readiness": {
        get: { tags: ["System"], summary: "Return JSON or CSV webhook SDK registry publish readiness, owner approvals, and smoke evidence blockers" }
      },
