...
- Provide owner-approved CMS/state licensing export files, API credentials, or data-use contracts so `/api/v1/admin/import-launch-execution` can run those queued batches instead of reporting adapter blockers.
